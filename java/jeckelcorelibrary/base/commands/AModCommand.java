package jeckelcorelibrary.base.commands;
...
public abstract class AModCommand extends CommandBase
{
	public AModCommand(final String commandName, final String usageText)
	{
		this(commandName, 0, usageText);
	}

	public AModCommand(final String commandName, int permLevel, final String usageText)
	{
